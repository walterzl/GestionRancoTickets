...
$(document).ready(function(){
    ...
    filtro(grupo_id,tip_id,area_id,tick_estado,usu_asig_est,tickoc_orden,estoc_id,fech_crea,tick_Planta)
...
function filtro(grupo_id,tip_id,area_id,tick_estado,usu_asig_est,tickoc_orden,estoc_id,fech_crea,tick_Planta){
    ...
    tabla=$('#ticket_data').dataTable({
        ...
        "ajax":{
            ...
            type : "post",
            dataType : "json",
            data:{grupo_id : grupo_id, tip_id:tip_id,area_id:area_id,tick_estado:tick_estado,usu_asig_est:usu_asig_est,sis_id:sis_id,tick_Planta:tick_Planta},
            error: function(e){
