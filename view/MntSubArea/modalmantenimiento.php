<div id="modalmantenimiento" class="modal fade bd-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" id="subarea_form">
                <div class="modal-body">
                    <input type="hidden" id="suba_id" name="suba_id">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="area_nom">Area *</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="suba_nom" name="suba_nom" placeholder="Ingrese Nombre" required>
                    </div>
