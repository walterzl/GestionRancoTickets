        ...
        <div class="modal-content">
            ...
            <form method="post" id="ticket_form">
                <div class="modal-body">
                    ...
                    <input type="hidden" id="tickoc_id" name="tickoc_id">

                    <div class="form-group">
                        <label class="form-label" for="usu_asig">Agente</label>
                        ...
                        <p></p>
                        <p>" Seleccione el agente a Asignar para posterior dar en GUARDAR, al dar en Guardar saldra una alerta (en 5s) de Asignacion correcta para seguido enviar el correo de aviso"</p>
                    </div>
