<?php
    class Ticketoc extends Conectar{
        ...
        public function insert_ticketoc($usu_id,$cat_id,$tickoc_titulo,$tickoc_descrip,$area_id,$suba_id,$tip_id,$ent_id,$cntcon_id,$dura_id,$tickoc_coti_cerra){
            $conectar= parent::conexion();
            /*consulta SQL*/
            $sis_id = $_SESSION["sis_id"];
            $sql="INSERT INTO tm_ticket_oc (sis_id,tickoc_corre,usu_id,cat_id,tickoc_titulo,tickoc_descrip,tickoc_estado,area_id,suba_id,fech_cierre,fech_crea,tip_id,ent_id,cntcon_id,dura_id,tickoc_coti_cerra,est) 
